import { ArrowRight, Check, Eye, FileText, GitBranch,Monitor, RefreshCw, Shield, Sparkles } from 'lucide-react';
...
function MarkdownLivePreviewContent({ locale }: { locale: string }) {
  ...
  const features = [
    ...
    { icon: FileText, title: t('feature4Title'), desc: t('feature4Desc'), color: '#ef4444' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            buildToolPageJsonLd(
              'Markdown Live Preview',
              'Free online Markdown live preview with sync scroll, dark mode, and instant PDF export in your browser.',
