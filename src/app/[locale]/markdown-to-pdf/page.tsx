...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildLocalizedPageMetadata({
    ...
    keywords: withToolBrandKeywords([
      ...
      'markdown to download',
      'convert md to pdf',
      'md to pdf vscode',
      '.m to pdf',
      'm to pdf',
      'convert github md to pdf',
      'how to turn md file into pdf',
      'markdown 轉 pdf',
      'markdown to png',
      'markdown 转 pdf',
      ...
      'unstructured pdf to markdown',
      'best pdf to markdown converter',
      // English (new)
      'convert md to pdf online free',
      'obsidian markdown export to pdf',
      'markdown to pdf command line pandoc',
      'notion markdown page to pdf',
      'github readme md to pdf tool',
      'markdown code syntax highlighting pdf',
      'markdown resume to pdf template',
      'automated md to pdf api',
      // Spanish
