...
import { NOTION_TO_PDF } from '@/content/seo-landings';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata({
    ...
    image: {
      ...
      width: 1200,
      height: 800,
      alt: 'Convert Notion pages (Markdown export) to PDF with tables and callouts',
    },
  });
}

export default async function NotionToPdfPage({
  params,
}: {
